       ...
       try
                {
                    ...
                    ResultSet rs=st.executeQuery("select max(DonorID)from donor_info");
         ...
         try
             {
               Connection con= dbconnection.getCon();
               Statement st=con.createStatement();
               st.executeUpdate("insert into donor_info values ('"+donorId+"','"+name+"','"+fathername+"','"+mothername+"','"+dob+"','"+mobilenumber+"','"+gender+"','"+email+"','"+bloodgroup+"','"+city+"','"+Address+"')");
