    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       String employeeId= jTextField_search.getText();
        ...
        try
        {
            Connection con= dbconnection.getCon();
            Statement st=con.createStatement();
            st.executeUpdate("update employee_info set Name='"+name+"',FatherName='"+fathername+"',MotherName='"+mothername+"',DOB='"+dob+"',MobileNumber='"+mobilenumber+"',Gender='"+gender+"',Email='"+email+"',BloodGroup='"+bloodgroup+"',City='"+city+"',Address='"+Address+"' where EmployeeID='"+employeeId+"' ");
